...
let s:p.normal.error = [[["#FF8867", 209], ["#181818", 234]]]
let s:p.normal.warning = [[["#FB5599", 204], ["#181818", 234]]]
...
let s:p.replace.left = [[["#23CCDD", 44], ["#181818", 234]], [["#EEEEEE", 255], ["#181818", 234]]]
let s:p.replace.middle = [[["#23CCDD", 44], ["#181818", 234]]]
let s:p.replace.right = [[["#23CCDD", 44], ["#181818", 234]], [["#23CCDD", 44], ["#181818", 234]]]
...
let s:p.tabline.tabsel = [[["#00BBFF", 39], ["#181818", 234]]]
